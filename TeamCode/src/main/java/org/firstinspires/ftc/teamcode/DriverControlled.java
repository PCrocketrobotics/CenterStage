    ...
    public void runOpMode() {
       ...
       // robot.getImuControl().readimuheading();
        ...
        while (opModeIsActive()) {
           ...
           robot.getArm_centerSTAGE().setPixle_drop();
           robot.getArm_centerSTAGE().setArm_liftMotor();
           robot.getArm_centerSTAGE().setAriplane_shooter();
           robot.getArm_centerSTAGE().setHANGING();
